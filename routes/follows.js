...
router.post('/followings/me/:followingId', checkAuth, followController.add_my_following);

router.delete('/followers/me/delete/:followerId', checkAuth, followController.delete_my_follower);

router.delete('/followings/me/delete/:followingId', checkAuth, followController.delete_my_following);
